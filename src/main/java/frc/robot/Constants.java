...
public final class Constants
{
  ...
  public static class Vision {
    ...
    public static final AprilTagFieldLayout kTagLayout =new AprilTagFieldLayout(List.of(new AprilTag(0, new Pose3d(new Pose2d(new Translation2d(ROBOT_MASS, LOOP_TIME), new Rotation2d(LOOP_TIME))))), ROBOT_MASS, LOOP_TIME); 
